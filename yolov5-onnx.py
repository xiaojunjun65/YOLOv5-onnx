...
class yolov5():
    ...
    def detect(self, srcimg):
        ...
        blob = cv2.dnn.blobFromImage(srcimg, 1 / 255.0, (640, 640), [0, 0, 0], swapRB=False, crop=False)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--net_type', default='yolov5s', choices=['yolov5s', 'yolov5l', 'yolov5m', 'yolov5x', 'origin', 'rubbish'])
